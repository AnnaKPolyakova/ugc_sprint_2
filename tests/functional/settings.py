...
class TestSettings(BaseSettings):
    ...
    log_file: str = Field(env="LOG_FILE", default="app.json")
    log_dir: str = Field(env="LOG_DIR", default="../logs/users_actions_app/")
    ...
    review_rating_collection: str = Field(
        env="REVIEW_RATING_COLLECTION", default="movie_review"
    )
    movie_review_collection: str = Field(
        env="MOVIE_REVIEW_COLLECTION", default="review_rating"
    )
